...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_update_user_returns_error(self):
        '''Test updating user of recipe returns error.'''
    ...
    def test_delete_other_users_recipe_error(self):
        '''Test deleting a recipe of another user is unsuccessful.'''
        new_user = create_user(email='user2@example.com', password='test123')
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        payload = {
            ...
            'time_minutes': 25,
            'price': Decimal('19.99'),
            'tags': [{'name': 'Italian'}, {'name': 'Chicken'}],
        }
    ...
    def test_update_recipe_assign_tag(self):
        '''Test assigning a tag to a recipe.'''
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 15,
            'price': Decimal('9.99'),
            'ingredients': [{'name': 'Chicken'}, {'name': 'Mozzarella Cheese'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
...
class ImageUploadTests(TestCase):
    '''Test image upload to recipe model.'''
